...
QT_MOC_LITERAL(1, 6, 9), // "helloResp"
QT_MOC_LITERAL(2, 16, 0), // ""
QT_MOC_LITERAL(3, 17, 7), // "success"
QT_MOC_LITERAL(4, 25, 7), // "message"
QT_MOC_LITERAL(5, 33, 8), // "sayHello"
QT_MOC_LITERAL(6, 42, 3) // "msg"

    },
    "Hello\0helloResp\0\0success\0message\0"
    "sayHello\0msg"
};
...
void Hello::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->helloResp((*reinterpret_cast< bool(*)>(_a[1])),(*reinterpret_cast< QString(*)>(_a[2]))); break;
        case 1: _t->sayHello((*reinterpret_cast< QString(*)>(_a[1]))); break;
        default: ;
        }
    } else if (_c == QMetaObject::IndexOfMethod) {
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            using _t = void (Hello::*)(bool , QString );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&Hello::helloResp)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void Hello::helloResp(bool _t1, QString _t2)
{
